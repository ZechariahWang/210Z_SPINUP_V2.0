...
void PurePursuitTestPath(){
    ...
    const double finalY = 80;
    CurvePoint StartPos(gx, gy, 0, 0, 10, 5, 1);
    CurvePoint newPoint1(5, 5, 0, 0, 10, 5, 1);
    CurvePoint newPoint2(10, 10, 0, 0, 10, 5, 1);
    CurvePoint newPoint3(20, 20, 0, 0, 10, 5, 1);
    ...
    while (true){
      ...
      if (fabs(sqrt(pow(finalX - gx, 2) + pow(finalY - gy, 2))) <= 20){
